...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Our plans start at $199/month + GST for small practices, with higher tiers for busier clinics. When you consider the cost of missed calls and the time saved by your staff, most practices see positive ROI within the first month."
    }
  ];
